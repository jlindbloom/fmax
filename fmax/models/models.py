...
class ForecastModel:
    ...
    def fit(self, 
        ...
        if self.attempts == "gaussian":
            ...
            random_sampler = fm.gaussian_random(n_periods=fcast_len, past_obs=self.train_data)
            ...
            if self.kind == "min":
                ...
                random_sampler = fm.gumbel_random_min(n_periods=fcast_len, past_obs=self.train_data)
